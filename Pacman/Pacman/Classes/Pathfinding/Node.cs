...
namespace Pacman.Classes.Pathfinding
{
    public class Node:IComparable
    {
        ...
        public List<Node> GetSuccessors()
        {
            ...
            Abstract_entities upperTile = Map.abstract_Entities[this.row - 1, this.column];// C.getNighbor()
            ...
            Abstract_entities lowerTile = Map.abstract_Entities[this.row + 1, this.column];// C.getNighbor()
            ...
            Abstract_entities leftTile = Map.abstract_Entities[this.row, this.column - 1];// C.getNighbor()
            if (!(leftTile is Wall))
            {
            ...
            Abstract_entities rightTile = Map.abstract_Entities[this.row, this.column + 1];// C.getNighbor()
