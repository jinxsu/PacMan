...
{
    public class Scared_Behavior: IBehavior
    {
        #region Singleton
        private static Scared_Behavior instance = null;
        private Scared_Behavior() { }

        public static Scared_Behavior GetInstance()
        {
            if (instance == null)
            {
                instance = new Scared_Behavior();
            }
            return instance;
        }
